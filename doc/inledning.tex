...
kan roteras och flyttas, detta är den typ som användes primärt senare i koden.
...
användarindata behandlas. När huvudloopen i programmet påbörjas så är all
 uppkoppling mot servern avklarad. I huvudloopen finns en case-sats som sköter 
...
erfarenhet av att rita grafik med s.k. Asciigrafik. Eftersom maxstorlekarna på 
...
modulus och divitioner och annan liknande mattemagi användes för att få 
